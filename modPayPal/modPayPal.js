...
/**
 * Supported values for the API parameter "CURRENCYCODE"
 * @enum
 * @properties={typeid:35,uuid:"2DC7B86C-B904-4B03-8F46-8DE3D60EA43F",variableType:-4}
 */
var CURRENCY_CODES = {
...
function NVPRequest() {
	...
	Object.defineProperty(this, 'user', {
			get: function() {
				return params[NVP_REQUEST_PARAMS.USER]
			},
			set: function(x) {
				params[NVP_REQUEST_PARAMS.USER] = x
			}
		});
	Object.defineProperty(this, 'password', {
			get: function() {
				return params[NVP_REQUEST_PARAMS.PWD]
			},
			set: function(x) {
				params[NVP_REQUEST_PARAMS.PWD] = x
			}
		});
	Object.defineProperty(this, 'signature', {
			get: function() {
				return params[NVP_REQUEST_PARAMS.SIGNATURE]
			},
			set: function(x) {
				params[NVP_REQUEST_PARAMS.SIGNATURE] = x
			}
		});
	Object.defineProperty(this, 'version', {
			get: function() {
				return params[NVP_REQUEST_PARAMS.VERSION]
			},
			set: function(x) {
				params[NVP_REQUEST_PARAMS.VERSION] = x
			}
		});
	Object.defineProperty(this, 'method', {
			get: function() {
				return params[NVP_REQUEST_PARAMS.METHOD]
			},
			set: function(x) {
				params[NVP_REQUEST_PARAMS.METHOD] = x
			}
		});
	Object.defineProperty(this, 'amount', {
			get: function() {
				return params[NVP_REQUEST_PARAMS.AMT]
			},
			set: function(x) {
				params[NVP_REQUEST_PARAMS.AMT] = x
			}
		});
	Object.defineProperty(this, 'currencyCode', {
			get: function() {
				return params[NVP_REQUEST_PARAMS.CURRENCYCODE]
			},
			set: function(x) {
				params[NVP_REQUEST_PARAMS.CURRENCYCODE] = x
			}
		});
	Object.defineProperty(this, 'paymentAction', {
			get: function() {
				return params[NVP_REQUEST_PARAMS.PAYMENTACTION]
			},
			set: function(x) {
				params[NVP_REQUEST_PARAMS.PAYMENTACTION] = x
			}
		});
	Object.defineProperty(this, 'ipAddress', {
			get: function() {
				return params[NVP_REQUEST_PARAMS.IPADDRESS]
			},
			set: function(x) {
				params[NVP_REQUEST_PARAMS.IPADDRESS] = x
			}
		});
	Object.defineProperty(this, 'creditCardType', {
			get: function() {
				return params[NVP_REQUEST_PARAMS.CREDITCARDTYPE]
			},
			set: function(x) {
				params[NVP_REQUEST_PARAMS.CREDITCARDTYPE] = x
			}
		});
	Object.defineProperty(this, 'account', {
			get: function() {
				return params[NVP_REQUEST_PARAMS.ACCT]
			},
			set: function(x) {
				params[NVP_REQUEST_PARAMS.ACCT] = x
			}
		});
	Object.defineProperty(this, 'expirationDate', {
			get: function() {
				return params[NVP_REQUEST_PARAMS.EXPDATE]
			},
			set: function(x) {
				params[NVP_REQUEST_PARAMS.EXPDATE] = x
			}
		});
	Object.defineProperty(this, 'cvv2', {
			get: function() {
				return params[NVP_REQUEST_PARAMS.CVV2]
			},
			set: function(x) {
				params[NVP_REQUEST_PARAMS.CVV2] = x
			}
		});
	Object.defineProperty(this, 'firstName', {
			get: function() {
				return params[NVP_REQUEST_PARAMS.FIRSTNAME]
			},
			set: function(x) {
				params[NVP_REQUEST_PARAMS.FIRSTNAME] = x
			}
		});
	Object.defineProperty(this, 'lastName', {
			get: function() {
				return params[NVP_REQUEST_PARAMS.LASTNAME]
			},
			set: function(x) {
				params[NVP_REQUEST_PARAMS.LASTNAME] = x
			}
		});
	Object.defineProperty(this, 'street', {
			get: function() {
				return params[NVP_REQUEST_PARAMS.STREET]
			},
			set: function(x) {
				params[NVP_REQUEST_PARAMS.STREET] = x
			}
		});
	Object.defineProperty(this, 'city', {
			get: function() {
				return params[NVP_REQUEST_PARAMS.CITY]
			},
			set: function(x) {
				params[NVP_REQUEST_PARAMS.CITY] = x
			}
		});
	Object.defineProperty(this, 'state', {
			get: function() {
				return params[NVP_REQUEST_PARAMS.STATE]
			},
			set: function(x) {
				params[NVP_REQUEST_PARAMS.STATE] = x
			}
		});
	Object.defineProperty(this, 'zip', {
			get: function() {
				return params[NVP_REQUEST_PARAMS.ZIP]
			},
			set: function(x) {
				params[NVP_REQUEST_PARAMS.ZIP] = x
			}
		});
	Object.defineProperty(this, 'countryCode', {
			get: function() {
				return params[NVP_REQUEST_PARAMS.COUNTRYCODE]
			},
			set: function(x) {
				params[NVP_REQUEST_PARAMS.COUNTRYCODE] = x
			}
		});
...
function NVPResponse(responseBody) {
	...
	Object.defineProperty(this, 'transactionID', {
			get: function() {
				return params[NVP_RESPONSE_PARAMS.TRANSACTIONID]
			}
		});
	Object.defineProperty(this, 'amount', {
			get: function() {
				return parseFloat(params[NVP_RESPONSE_PARAMS.AMT])
			}
		});
	Object.defineProperty(this, 'avsCode', {
			get: function() {
				return params[NVP_RESPONSE_PARAMS.AVSCODE]
			}
		});
	Object.defineProperty(this, 'cvv2Match', {
			get: function() {
				return params[NVP_RESPONSE_PARAMS.CVV2MATCH]
			}
		});
	Object.defineProperty(this, 'paymentAdviceCode', {
			get: function() {
				return params[NVP_RESPONSE_PARAMS.PAYMENTADVICECODE]
			}
		});
	Object.defineProperty(this, 'ack', {
			get: function() {
				return params[NVP_RESPONSE_PARAMS.ACK]
			}
		});
	Object.defineProperty(this, 'errorCode', {
			get: function() {
				return params[NVP_RESPONSE_PARAMS.L_ERRORCODE0]
			}
		});
	Object.defineProperty(this, 'shortErrorMessage', {
			get: function() {
				return params[NVP_RESPONSE_PARAMS.L_SHORTMESSAGE0]
			}
		});
	Object.defineProperty(this, 'longErrorMessage', {
			get: function() {
				return params[NVP_RESPONSE_PARAMS.L_LONGMESSAGE0]
			}
		});
...
function doDirectPayment(callbackMethod, amount, firstName, lastName, street, city, state, zip, countryCode, creditCardType, account, expirationDate, cvv2) {
	...
	function formatNumber(num) {
		var payPalSymbols = new java.text.DecimalFormatSymbols();
		payPalSymbols.setDecimalSeparator( (new java.lang.String('.')).charAt(0));
		payPalSymbols.setGroupingSeparator( (new java.lang.String(',')).charAt(0));
		var format = new java.text.DecimalFormat("#,##0.00", payPalSymbols);
		return format.format(num);
	}

	req.amount = formatNumber(amount);
	req.creditCardType = creditCardType;
	req.account = account.replace(/[^\d]/g, '');
	;
	req.expirationDate = (expirationDate instanceof Date) ? utils.dateFormat(expirationDate, 'MMyyyy') : expirationDate;
	if (cvv2) req.cvv2 = cvv2;
...
function getHeadlessClient() {
	...
	if (!client) {
		...
		if (!uid || !security.checkPassword(uid, remoteUserPassword) || security.getUserGroups(uid).getMaxRowIndex() < 1)
			throw new scopes.modUtils$exceptions.IllegalStateException('Failed to authenticate remote dispatch user "' + remoteUserName + '" for PayPal Remote Dispatch Client. ' + 'Ensure that the account exists and has correct credentials and is valid/belongs to a valid group.');
